...
<div id="boardcontents_placeholder">
	...
	<div id="logical_clock_placeholder" class="boardtitle">Logical clock: {{logical_clock}}</div>
    <input type="text" name="id" value="ID" readonly>
    <input type="text" name="entry" value="Entry" size="70%%" readonly>
    % for board_entry, board_element in board_dict:
		<form class="entryform" target="noreload-form-target" method="post" action="/board/{{board_entry[0]}}/{{board_entry[1]}}/{{board_entry[2]}}">
